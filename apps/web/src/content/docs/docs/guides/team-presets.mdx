...
preset-supplied code. Use one when a team needs the same defaults across repositories or when a
distribution should start from an organization-owned baseline.
