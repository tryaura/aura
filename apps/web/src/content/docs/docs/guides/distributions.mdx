...
1. Install the public packages at one version.
   ...
   ```sh
   pnpm add @tryaura/aura-cli@0.5.2 @tryaura/aura-sdk@0.5.2 @tryaura/aura-testkit@0.5.2
...
5. [Ship it](/docs/guides/ship-a-distribution/) when the source command is right: asset staging,
