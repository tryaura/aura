...
| `AURA_VERSION`     | latest release | Install a specific tag, for example `v0.2.1`. |

```sh
AURA_INSTALL_DIR=/usr/local/bin AURA_VERSION=v0.2.1 curl -fsSL https://tryaura.sh/install | sh
```
