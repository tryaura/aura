...
describe("aura check --fix", () => {
  it("atomically wires Claude Code, Codex, and Cursor and is idempotent", async () => {
    ...
    expect(first.stdout).toContain("12 passed, 0 informational, 0 warnings, 0 errors");
    ...
    expect(second.stdout).toContain("12 passed, 0 informational, 0 warnings, 0 errors");
