...
request. Its dependencies are `workspace:*` for that reason; a real distribution pins
...
See the [Ship a distribution guide](../../apps/web/src/content/docs/docs/guides/ship-a-distribution.mdx)
